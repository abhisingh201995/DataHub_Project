...
public class SeedHomePage extends basePage{
	...
	private By hamburger = By.xpath("//span[@class='icon-k-menu']");
	...
	public boolean verifyAdditionalPropertiesBtn(){
		return seleniumHelper.validateElementPresent(driver,BUTTON_ADDITIONALPROPERTIES);
	}

	public SeedAdminAdditionalProperties clickAdditionalPropertiesButton() {
		seleniumHelper.clickElement(driver, BUTTON_ADDITIONALPROPERTIES);
